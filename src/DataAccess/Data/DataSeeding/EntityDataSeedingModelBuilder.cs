...
internal static class EntityDataSeedingModelBuilder
{
    ...
    private static List<Role> InitRoles()
    {
        ...
        newRoleNames.Add(key: Guid.Parse("c39aa1ac-8ded-46be-870c-115b200b09fc"), value: "user");

        newRoleNames.Add(key: Guid.Parse("c8500b46-b134-4b60-85b7-8e6af1187e0c"), value: "admin");
